...
namespace _0.Game.Scripts.Editor
{
    public class RemoveMissingScriptsUtility : EditorWindow
    {
        ...
        {
            GetWindow(typeof(RemoveMissingScriptsUtility));
        }
        ...
        public void OnGUI()
        {
            ...
            if (GUILayout.Button("Select GameObjects with Missing Scripts"))
                SelectGameObjectsWithMissingScripts(UnityEngine.SceneManagement.SceneManager.GetActiveScene()
                    .GetRootGameObjects());
